    ...
    <section id="harga-member" class="py-24 bg-slate-950 relative">
        ...
        <div class="max-w-screen-xl mx-auto px-4 relative z-10">
            ...
            <div class="text-center mt-16" data-aos="fade-up">
                <a href="https://wa.me/6288801238937" target="_blank" class="inline-flex items-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg transition shadow-lg hover:shadow-green-600/30">
